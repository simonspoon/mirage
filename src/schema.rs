...
mod tests {
    ...
    fn test_category_ddl() {
        ...
        assert!(ddl.contains("id INTEGER"), "should contain 'id INTEGER'");
        assert!(ddl.contains("name TEXT"), "should contain 'name TEXT'");
    }
    ...
    fn test_pet_ddl_columns() {
        ...
        assert!(ddl.contains("status TEXT"), "should contain 'status TEXT'");
        assert!(
            ddl.contains("category TEXT"),
            "should contain 'category TEXT'"
        );
        assert!(ddl.contains("tags TEXT"), "should contain 'tags TEXT'");
    }
